...
class DetectionLoss(nn.Module):
    ...
    def __init__(self, model, tal_topk: int = 10):  # model must be de-paralleled
        ...
        # self.proj = torch.arange(m.reg_max, dtype=torch.float)
...
class OBBLoss(DetectionLoss):
    ...
    def __init__(self, model):
        """Initialize OBBLoss with model, assigner, and rotated bbox loss; model must be de-paralleled."""
...
# class v8SegmentationLoss(DetectionLoss):
